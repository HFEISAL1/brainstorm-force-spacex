        ...
        <div className="container mx-auto">
                ...
                {launch?.mission_name ? (
                    <>
                        ...
                        <span className="relative rounded-md shadow-sm ml-8 hidden xl:inline-flex">
                            ...
                            />
                            <span className={`relative inline-flex rounded-full h-6 w-6 ${launch?.launch_success ? "bg-green-500" : "bg-red-500"}`} />
                        </span>
                    </>
                ) : (
                    "Loading..."
            ...
            <div className="flex flex-col items-center my-14 mx-20 text-center sm:text-left xl:flex-row">
                <div className="flex flex-col w-full xl:w-1/2">
                    ...
                    <p className="text-base">{launch ? launch?.details ?? "No data" : "Loading..."}</p>
                    ...
                    <div className="flex flex-col justify-between sm:flex-row">
                        ...
                        <div className="w-full sm:w-3/4">
                            ...
                            {launch?.launch_date_utc ? new Date(launch?.launch_date_utc).toLocaleDateString("en-GB") : "Loading..."}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between sm:flex-row">
                        <div className="w-full mr-5">
                            ...
                            {launch?.rocket?.rocket_name ? (
                                <Link className="text-blue-600" to={`/rockets/${launch?.rocket.rocket_id}`}>
                                    {launch?.rocket?.rocket_name}
                                </Link>
                            ) : (
                                "Loading..."
                        ...
                        <div className="w-full sm:w-3/4">
                            ...
                            {launch ? (
                                launch?.links?.wikipedia ? (
                                    <a className="text-blue-600" href={launch?.links?.wikipedia} target="_blank" rel="noreferrer">
                                        Wikipedia
                                    </a>
                                ) : (
                                    "No data"
