...
const Rocket = ({ name, active, description, country, firstFlight, diameter, height, imageUrl, isLoading }) => {
    if (isLoading) {
        return (
        ...
        <div className="container mx-auto">
            <h1 className="flex justify-center w-full text-5xl font-bold leading-tight items-center my-14">
                ...
                <span className="relative rounded-md shadow-sm ml-8 hidden xl:inline-flex">
                    ...
                    />
                    <span className={`relative inline-flex rounded-full h-6 w-6 ${active ? "bg-green-500" : "bg-red-500"}`} />
                </span>
            </h1>
            <div className="flex flex-col items-center my-14 mx-20 text-center sm:text-left xl:flex-row">
                <div className="flex flex-col w-full xl:w-1/2">
                    ...
                    <div className="flex flex-col justify-between sm:flex-row">
                        ...
                        <div className="w-full sm:w-3/4">
                            ...
                            <span className="">{new Date(firstFlight).toLocaleDateString("en-GB")}</span>
                        </div>
                    </div>
                ...
                <div className="w-full xl:ml-20 xl:w-1/2">
                    <Image className="w-full mt-16 rounded-lg hidden sm:block xl:mx-12 xl:mt-5" src={imageUrl} width="640px" height="480px" />
                </div>
            </div>
        </div>
    );
