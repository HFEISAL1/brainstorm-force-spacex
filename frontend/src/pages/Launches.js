...
const Launches = () => {
    ...
    const [currentPage, setCurrentPage] = useState(query.has("page") ? +query.get("page") : FIRST_PAGE);
    const [lastPage, setLastPage] = useState();
    const [isLoading, setIsLoading] = useState(true);
    const [rocketName, setRocketName] = useState(query.has("rocketName") ? query.get("rocketName") : "");
    const [launchYear, setLaunchYear] = useState(query.has("launchYear") ? query.get("launchYear") : "");
    const [launchSuccess, setLaunchSuccess] = useState(query.has("launchSuccess") ? query.get("launchSuccess") : "");
    ...
    return (
        <Screen>
            ...
            <Filter filterChangeHandler={filterChangeHandler} rocketName={rocketName} launchYear={launchYear} launchSuccess={launchSuccess} />
            <LaunchList launches={launches} isLoading={isLoading} />
            <Pagination pageChangeHandler={pageChangeHandler} firstPage={FIRST_PAGE} currentPage={currentPage} lastPage={lastPage} />
        </Screen>
    );
};
